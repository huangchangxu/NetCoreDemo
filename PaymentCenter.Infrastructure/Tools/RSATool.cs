...
namespace PaymentCenter.Infrastructure.Tools
{
    ...
    public class RSATool
    {
        ...
        /// <returns></returns>
        public static string Decrypt(Encoding encoding, string privateKey, string cipherText)
        {
            var privateKeyRsaProvider= CreateRsaProviderFromPrivateKey(privateKey);
        ...
        /// <returns></returns>
        public static string Encrypt(Encoding encoding, string publicKey, string text)
        {
            var publicKeyRsaProvider= CreateRsaProviderFromPublicKey(publicKey);
