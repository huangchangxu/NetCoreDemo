...
{
    public partial class JsonSplitTool
    {
        ...
        public static List<Dictionary<string, string>> Split(string json)
        {
    ...
    public partial class JsonSplitTool
    {
        public static List<string> SplitEscapeArray(string jsonArray)
        {
